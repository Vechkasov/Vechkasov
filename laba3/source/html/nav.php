                        ...
                        <?php
                            ...
                            if (isset($_SESSION['user']))
                                    echo "  <li  class='nav-item'>
                                            ...
                                            <li  class='nav-item'>
                                                <a class='nav-link btn btn-outline-secondary' href='signIn/exit.php'><b>ВЫЙТИ</b></a>
                                        </li>";
                            // Пользователь не авторизован
                            else
                                echo "<li  class='nav-item'>
                                            <a class='nav-link btn btn-outline-secondary' href='signIn/autho.php'><b>ВОЙТИ</b></a>
                                      </li>";
                            ?>
                    </ul>
                </div>
