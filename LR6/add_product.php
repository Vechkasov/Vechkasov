...
require_once("logic/add_logic.php");
?>

<div class="container">
    <h1 class="pt-2 mb-3">Добавление товара</h1>
    ...
    <div class="d-flex align-items-center flex-column pt-3 h5">
        ...
        <form action="add_product.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control mt-1 input-lg" name="name" placeholder="Название продукта" value="<?=isset($_POST['name'])?htmlspecialchars($_POST['name']):"";?>">
            ...
            <textarea name="description" class="form-control" cols="30" rows="3" placeholder="Описание продукта"><?=isset($_POST['description'])?htmlspecialchars($_POST['description']):"";?></textarea>
            ...
            <input type="text" class="form-control mt-1" name="cost" placeholder="Стоимость продукта" value="<?=isset($_POST['cost'])?htmlspecialchars($_POST['cost']):"";?>">
