    ...
    <div class="container">
        <h1 class="pt-2 mb-3">Изменение</h1>
        ...
        <div class="align-items-center w-50 pt-3 h5">
            <form class="form-control" method="post" enctype="multipart/form-data">
                ...
                <select class="form-select mt-1" name="category" title="Группа">
                    ...
                    {
                        if (isset($_POST['category']) && $_POST['category'] == $categories[$i]['id'])
                            echo "<option value=" . $categories[$i]['id'] . " selected>" . $categories[$i]['name'] . "</option>";
                        else if (!isset($_POST['category']) && isset($product['id_category']) && $product['id_category'] == $categories[$i]['id'])
                            echo "<option value=" . $categories[$i]['id'] . " selected>" . $categories[$i]['name'] . "</option>";
                        else
